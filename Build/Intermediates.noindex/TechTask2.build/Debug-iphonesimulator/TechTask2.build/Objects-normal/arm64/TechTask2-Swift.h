...
#ifndef TECHTASK2_SWIFT_H
#define TECHTASK2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TechTask2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9TechTask211AppDelegate")
...
SWIFT_CLASS("_TtC9TechTask228BannerTechTaskViewController")
@interface BannerTechTaskViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9TechTask213SceneDelegate") SWIFT_AVAILABILITY(ios,introduced=13.0)
